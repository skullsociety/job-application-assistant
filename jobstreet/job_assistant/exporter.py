...
def export_jobs(jobs: list[Job], output: Path) -> Path:
    ...
    title = sheet["A1"]
    title.value = "Unified Job Application Tracker"
    ...
    temporary_output = output.with_name(f".{output.stem}.{uuid4().hex}.xlsx")
    try:
        book.save(temporary_output)
...
def _platform_from_url(url: str) -> str:
    ...
    if hostname == "jobstreet.com" or ".jobstreet.com" in hostname or hostname.startswith("jobstreet.com."):
        return "JobStreet"
