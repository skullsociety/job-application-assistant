...
class UrlTests(unittest.TestCase):
    ...
    def test_jobstreet_tracking_url_becomes_stable_url(self) -> None:
        url = "https://sg.jobstreet.com/job/81234567?type=standard&ref=search-standalone"
        self.assertEqual(canonicalize_job_url(url), "https://sg.jobstreet.com/job/81234567")

    def test_jobstreet_split_view_url_becomes_stable_job_url(self) -> None:
        url = "https://sg.jobstreet.com/data-jobs/in-Singapore?jobId=94300636&type=standard"
        self.assertEqual(canonicalize_job_url(url), "https://sg.jobstreet.com/job/94300636")

    def test_jobstreet_lookalike_domain_is_not_treated_as_jobstreet(self) -> None:
        url = "https://evil-jobstreet.com/job/81234567?utm_source=test"
        self.assertEqual(canonicalize_job_url(url), "https://evil-jobstreet.com/job/81234567")
